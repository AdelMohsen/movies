...
class TopRatedPreviewScreen extends StatelessWidget {
  final TopRated topRated;
  final int index;

  TopRatedPreviewScreen(this.topRated, this.index);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          MainCubit()..getPopularVideos(videosId: topRated.result[index].id),
      child: BlocConsumer<MainCubit, MainStates>(
        ...
        builder: (context, state) {
          ...
          return Conditional.single(
            context: context,
            conditionBuilder: (context) => topRated.result.length != 0,
                                    ...
                                    child: Padding(
                                      ...
                                      child: Card(
                                        ...
                                        child: FadeInImage.assetNetwork(
                                            ...
                                            image:
                                                '$imageUrl${topRated.result[index].inSideImage}'),
                                      ),
                                    )),
                                Expanded(
                                    flex: 1,
