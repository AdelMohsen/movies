...
class UpComingPreviewScreen extends StatelessWidget {
  final UpComing upComing;
  final int index;

  UpComingPreviewScreen(this.upComing, this.index);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          MainCubit()..getPopularVideos(videosId: upComing.result[index].id),
      child: BlocConsumer<MainCubit, MainStates>(
        ...
        builder: (context, state) {
          ...
          return Conditional.single(
            context: context,
            conditionBuilder: (context) => upComing.result.length != 0,
                    ...
                    children: [
                                    ...
                                    child: Padding(
                                      ...
                                      child: Card(
                                        ...
                                        child: FadeInImage.assetNetwork(
                                            ...
                                            image:
                                                '$imageUrl${upComing.result[index].inSideImage}'),
                                      ),
                                    )),
                                Expanded(
                                    flex: 1,
                      ...
                      Conditional.single(
                        ...
                        conditionBuilder: (context) =>
                            ...
                            videoModel!.result!.length != 0,
                        widgetBuilder: (context) => Container(
                          height: 200,
                          child: ListView.separated(
                              scrollDirection: Axis.horizontal,
                              itemBuilder: (context, index) => ytPlayer(
                                  context, '${videoModel!.result![index].key}'),
